...
Thank you for your interest in `loopback-example-angular`, an open source project
administered by StrongLoop.

Contributing to `loopback-example-angular` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/strongloop/loopback-example-angular)
